    ...
    return (
        <div className="flex flex-col gap-6">
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-6">
                <CardStats title={"Total Users"} stats={users} color="blue" icon={Users}></CardStats>
                <CardStats title={"Active Hosts"} stats={hosts} color="green" icon={Home}></CardStats>
                <CardStats title={"Residences"} stats={residences} color="purple" icon={Building2}></CardStats>
                <CardStats title={"Bookings"} stats={bookings} color="pink" icon={CalendarDays}></CardStats>
                <CardStats title={"Feedbacks"} stats={feedbacks} color="red" icon={MessageSquare}></CardStats>
